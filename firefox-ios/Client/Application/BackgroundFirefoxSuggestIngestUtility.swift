...
final class BackgroundFirefoxSuggestIngestUtility: BackgroundUtilityProtocol, LegacyFeatureFlaggable, @unchecked Sendable {
    static let taskIdentifier = "app.floorp.suggest.ingest"
