...
extension GleanMetrics {
    class GleanBuild {
        ...
        public static let info = BuildInfo(buildDate: DateComponents(calendar: Calendar.current, timeZone: TimeZone(abbreviation: "UTC"), year: 1970, month: 1, day: 1, hour: 0, minute: 0, second: 0))
    }
