...
def load_review_receipt(path: Path, source: dict[str, Any]) -> tuple[dict[str, Any], str]:
    ...
    for field in (
        ...
        "merge_response_sha256", "operation_receipt_sha256", "audit_event_id_sha256", "audit_projection_sha256",
    ):
...
def main(arguments: list[str] | None = None) -> int:
    ...
    try:
        ...
        event = {
            ...
            "audit_event_id_sha256": review["audit_event_id_sha256"],
            "audit_event_timestamp": review["audit_event_timestamp"],
            ...
            "operation_receipt_sha256": review["operation_receipt_sha256"],
