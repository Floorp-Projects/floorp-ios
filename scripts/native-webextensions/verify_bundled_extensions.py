...
EXPECTED = (
    ...
    },
    {
        ...
        "support_files": {
            "firefox-ios/Floorp/NativeWebExtensions/Bundled/uBOLite-floorp-ios-2026.825.1619.patch": "978ffc5faaec24276072bfa32af3c84bcf6492d020769bd717715955bad2d4e9",
        ...
        "provenance": {
            ...
            "changes": [
                ...
                {
                    "description": "Expose host-awaited dashboard and popup close handshakes that drain in-flight mutations, reconcile/read back protection, preserve harmless immediate no-edit popup close, begin host-permission requests in the original Page Action user-gesture stack before awaiting serialized mutations, avoid host-permission requests for pages without hostnames, never derive an empty ruleset selection from the dashboard's deferred unrendered Filter lists pane, normalize DOM collections before selection readback, keep failed surfaces open for retry or explicit native escape, roll controls back without reloading on error, and present accessible runtime errors.",
                    "patch": "uBOLite-floorp-ios-2026.825.1619.patch",
                    "paths": [
                        "css/popup.css",
                        "css/settings.css",
            ...
            "sha256": "0bf4f4ce6716a971bcf03bf1e18612161a6005152a37b591bf54200b00eb5a6d",
