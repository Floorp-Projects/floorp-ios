...
input, artifact inventory, managed sequence-4 signature, archive provenance,
...
- release state: **sequence 4 signed and locally verified**. The catalog SHA-256
  is `f6f99259ae3a8813ed342c9859ed6a695b95def017fbf3b0f23342f67a7b7177`;
  ...
  required. The sequence-3 one-package and sequence-2 17-package signatures and
  approvals are historical.
...
| --- | --- | --- |
| Current Dark Reader-only catalog contracts | pass — 98 Python tests; functional 1 / 1 | One input, package, artifact, review tree, provenance record, workflow count, tester copy, and no production fixture resources. Required GitHub CI passed on source PR #151 and extension-management UI PR #154 before sequence-4 signing from exact `main` `b717f95771da53f4ff8233f2b0b7da0545c742f0`. |
...
| Historical source-phase app-bundle resource audit | pass — one FWEA1, no fixtures | Simulator build の `Client.app/Artifacts` に `thirdparty-darkreader.fwea1` 1件と signed resources だけが存在し、3 test fixture と他の FWEA1 は存在しない。当時の signed `catalog.json` は旧 sequence 2 であり release candidate ではなかった。この観察は sequence-4 の署名・tag-bound build 証跡を代替しない。 |
...
| Current Dark Reader-only managed signing, release verification, and P0 record | pass — 1 package / sequence 4 | 2026-08-31、required CIを通過した clean `main` `b717f95771da53f4ff8233f2b0b7da0545c742f0` で、1Password SSH Agent の non-export root/leaf signerを使用。catalog schema 3 / sequence 4、issued/expires `2026-08-30T23:52:46Z` / `2026-09-13T23:52:46Z`、public catalog SHA-256 `f6f99259ae3a8813ed342c9859ed6a695b95def017fbf3b0f23342f67a7b7177`、root raw-key SHA-256 `d69df8b7bda4b1a66636ef421be53b86f99f4cf38cea0f900b63b801e889f6a3`。root-public-key file SHA-256 `23146d4cb799673205a0372ae6b6e319a0e0e16df744bfa5695ae2508384dee8` は sequence 3 から不変。Dark Reader archive provenance evidence SHA-256 `6be33b7ec2045628e87710680dde5eb59cd39ed463f6d8e66acb86444335e2b2`、release-verifier evidence SHA-256 `fef425a5a96037b8b31c0a6a5f0a702f5708914c927c86a569a95ce85daa0e88`、canonical schema-2 approval SHA-256 `97402df63a53a1e109c15e8655d8694ce4dc136a480e9e352f8471587730a793`、approval-verifier evidence SHA-256 `0456be0e858761bfe86049dfc0146cc6ea30a3a3133ccbd3d8185ffe7632d447`。秘密鍵をGitHub、Xcode Cloud、app bundle、ログへ置いていない。 |
...
| current candidate tester / reviewer materials | prepared, not submitted | `WhatToTest.en-US.txt` / `ja-JP.txt` と Beta App Review draft は Dark Reader-only の手順へ更新済み。sequence-4 exact approvalは完成。source-bound buildとworkflow readback後に提出する。 |
| workflow / Xcode Cloud run for this source | not started — extension-management UI PR #154 is merged at `b717f95771da53f4ff8233f2b0b7da0545c742f0`, and its sequence-4 public output/approval are locally verified. A normal public-output PR/CI merge and protected annotated `floorp-catalog-<40 lowercase commit SHA>` tag remain required. Candidate and external environment secret names (`APPLE_DEVELOPER_API_KEY_JSON`, root digest, and external approval digest) are present; values remain unread and workflows must compare the protected digests with the actual signed outputs before Apple mutation. |
